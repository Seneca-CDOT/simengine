...
See `simengine-cli model update {asset_type} -h` for the list of supported properties and [Assets Configurations](./Assets&#32Configurations.md) page for more detailed documentation. 
