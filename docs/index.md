...
The engine can reconstruct behaviour of system’s core components such as PDUs & servers (running the VMs). PDUs support SNMP interface and servers can be set up with an optional IPMI simulator.  
